destinos = {'villaguay': """S̲A̲L̲I̲D̲A̲ ̲L̲L̲E̲G̲A̲D̲A̲ ̲E̲M̲P̲R̲E̲S̲A̲ ̲O̲B̲S̲E̲R̲V̲A̲C̲.̲
...
21:43  23:45 *ZENIT*
""" ,'villa clara': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""" , 'victoria': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""" , 'viale': """SALIDA LLEGADA EMPRESA OBSERVAC.
04:50  08:00 *E.T.A*
18:20  21:30 *no definido* 
""" , 'ubajay': """SALIDA LLEGADA EMPRESA OBSERVAC.
07:00  07:45 *RIO URUGUAY* _solo lunes-miercoles-jueves-viernes_
""" , 'santa fe': """SALIDA LLEGADA EMPRESA OBSERVAC.
21:43  02:50 *ZENIT*
...
""" , 'san salvador': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'retiro': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'puerto iguazu': """SALIDA LLEGADA EMPRESA OBSERVAC.
19:15  07:00 *SINGER* 
19:45  08:00 *TIGRE IGUAZU* 
21:30  09:00 *CRUCERO NORTE* 
21:00  09:30 *RAPIDO ARGENTINO* 
""", 'posadas': """SALIDA LLEGADA EMPRESA OBSERVAC.
19:15  04:00 *SINGER* 
...
""", 'nueva escocia': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'nogoya': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'monte caseros': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'mocoreta': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'mercedes': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'gualeguaychu': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'gualeguay': """SALIDA LLEGADA EMPRESA OBSERVAC.
18:00  00:00 *JOVI BUS* 
08:25  14:00 *JOVI BUS* 
""", 'general campos': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'federación': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'curuzu cuatia': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'corrientes': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'cordoba': """SALIDA LLEGADA EMPRESA OBSERVAC.
21:43  07:20 *ZENIT* 
22:20  08:00 *MERCOBUS*-PLUS ULTRA _viernes y domingos_
""", 'concepción del uruguay': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'colonia ayui': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'colon': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'chajari': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'calabacilla': """SALIDA LLEGADA EMPRESA OBSERVAC.
...
""", 'basavilbaso': """SALIDA LLEGADA EMPRESA OBSERVAC.
